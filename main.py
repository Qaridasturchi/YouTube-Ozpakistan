...
async def start(client, message):
   await message.reply_text(
      ...
      reply_markup=InlineKeyboardMarkup(
         [
            [
               InlineKeyboardButton("❕ ┇ كيفيه استخدام البوت", url=f"https://t.me/MuzXMusicc/3251"),
...
async def search(client, message):
    try:
        ...
        while i < 5:
            ...
            i += 1
        await m.edit(text, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Serø ⁞ Bots Service", url="https://t.me/MuzXMusicc")]]), disable_web_page_preview=True)
    except Exception as e:
        await m.edit(str(e))
